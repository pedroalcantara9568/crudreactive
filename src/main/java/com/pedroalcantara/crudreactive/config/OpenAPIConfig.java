package com.pedroalcantara.crudreactive.config;
...
@Configuration
@OpenAPIDefinition(info = @Info(title = "API Open Banking Payments Pedro", version = "v1"))
public class OpenAPIConfig {
    ...
    private io.swagger.v3.oas.models.info.Info getUnfi() {
        ...
        return new io.swagger.v3.oas.models.info.Info()
                .title("Sistema Open Banking - Pedro Alcantara")
